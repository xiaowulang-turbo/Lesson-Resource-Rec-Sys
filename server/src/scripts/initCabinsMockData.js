...
const initMockData = async () => {
    try {
        ...
        // 创建用户
        const hashedPassword = await generatePasswordHash('example0987')
        ...
        // 创建小木屋
        const cabins = await Cabin.create([
            {
                name: '001号小木屋',
                maxCapacity: 2,
                regularPrice: 250,
        ...
        for (let i = 0; i < 10; i++) {
            ...
            const booking = {
                ...
                totalPrice:
                    randomCabin.regularPrice * numNights -
                    (hasBreakfast ? 0 : randomCabin.discount),
                status,
                hasBreakfast,
                observations: '无特殊要求',
                isPaid,
        ...
        console.log('Jonas - Email: jonas@example.com, 密码: password123\n')
    } catch (error) {
