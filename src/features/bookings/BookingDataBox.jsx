...
function BookingDataBox({ booking }) {
    ...
    // 兼容旧字段名
    const nights = duration || booking.numNights || 0
    ...
    const observations = notes || booking.observations || ''
        ...
        <StyledBookingDataBox>
            <Header>
                <div>
                    <HiOutlineHomeModern />
                    <p>
                        {nights} nights in Cabin <span>{resourceName}</span>
                    </p>
                </div>
                {startDate && endDate && (
                    <p>
