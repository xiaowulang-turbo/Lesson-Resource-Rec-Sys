    ...
    const data = allDates.map((date) => {
        return {
            ...
            totalSales: bookings
                ...
                .reduce((acc, cur) => {
                    return acc + (cur.totalPoints || cur.totalPrice || 0)
                }, 0),
            extrasSales: bookings
                ...
                .reduce((acc, cur) => {
                    const hasExtras =
                        cur.includesMaterials || cur.hasBreakfast || false
                    const extraPrice = hasExtras
                        ? (cur.totalPoints || cur.totalPrice || 0) * 0.15
                        : 0
